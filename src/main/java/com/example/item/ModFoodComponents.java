...
public class ModFoodComponents {
    ...
    public static final FoodComponent LILYFISH = new FoodComponent.Builder().nutrition(3).saturationModifier(0.25f).build();
    static final FoodComponent CABBAGE = new FoodComponent.Builder().nutrition(3).saturationModifier(0.25f).build();
}
